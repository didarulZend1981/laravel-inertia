<template>
    <div>
        ...
        <div id="sideNav" class="side-nav-open">
            ...
            <Link href="/SuplayerPage" class="side-bar-item">
                <span class="side-bar-item-icon"><i class="fa fa-th-list text-green" /></span>
                <span class="side-bar-item-caption">Suplayer</span>
            </Link>

            <Link href="/ProductNamePage" class="side-bar-item">
            ...
            <Link href="/ProductPage" class="side-bar-item">
             ...
             <Link href="/create-sale" class="side-bar-item">
                ...
                <span class="side-bar-item-caption">Create buy</span>
            </Link>
